...
describe('ControlPlanePage', () => {
  ...
  it('renders customer route workspace without the geometry editor', async () => {
    ...
    expect(screen.getByText('DJI Home Point')).toBeInTheDocument()
    expect(screen.getByText('3 個航點')).toBeInTheDocument()
    expect(screen.getByText('航點完成後返航')).toBeInTheDocument()
