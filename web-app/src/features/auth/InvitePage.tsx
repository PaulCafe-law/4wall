  ...
  return (
    <div className="min-h-screen bg-grain px-6 py-10">
      <div className="mx-auto grid max-w-5xl gap-6 md:grid-cols-[minmax(0,1fr)_26rem]">
        <Panel>
          <p className="font-mono text-[11px] uppercase tracking-[0.3em] text-ember-500">邀請存取</p>
          ...
          <p className="mt-4 max-w-2xl text-base text-chrome-700">
            如果你是由內部團隊或客戶管理者邀請加入，請在這裡輸入邀請代碼、設定顯示名稱與密碼，完成帳號開通。
          </p>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-chrome-200 bg-chrome-50/70 p-4">
              ...
              <p className="mt-2 text-sm text-chrome-700">加入既有組織後，就能依角色查看任務與報表。</p>
            </div>
            <div className="rounded-2xl border border-chrome-200 bg-chrome-50/70 p-4">
              <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-chrome-500">安全登入</p>
              <p className="mt-2 text-sm text-chrome-700">完成開通後，你就可以用新密碼直接登入網站。</p>
            </div>
            <div className="rounded-2xl border border-chrome-200 bg-chrome-50/70 p-4">
              <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-chrome-500">如果沒有邀請？</p>
              <p className="mt-2 text-sm text-chrome-700">請聯絡管理者重新發送邀請，或自行建立新的組織帳號。</p>
            </div>
          </div>
        </Panel>
        ...
        <Panel className="self-start">
          ...
          <p className="mt-2 text-sm text-chrome-700">輸入邀請代碼、顯示名稱與密碼。</p>
